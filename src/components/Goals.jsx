  ...
  return (
    <section className="section-padding relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        {/* Commitment box */}
        <div className="mt-14 max-w-4xl mx-auto card-elegant bg-gradient-to-br from-sky-50/80 to-blue-200/70 backdrop-blur-sm p-8 md:p-10 border border-primary-200/40 animate-fade-in-up">
          <div className="relative z-10 text-center">
