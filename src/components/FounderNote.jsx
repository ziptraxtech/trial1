  ...
  return (
    <section id="founder" className="section-padding relative overflow-hidden">
      ...
      <div className="container-custom relative z-10 max-w-4xl mx-auto">
        ...
        <div className="animate-fade-in-up card-elegant bg-gradient-to-br from-sky-50/80 to-blue-200/70 backdrop-blur-sm overflow-hidden border border-primary-200/40">
          {/* Navy accent bar */}
