  ...
  return (
    <section id="founder" className="section-padding bg-gradient-to-b from-primary-100 to-primary-200 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10 max-w-4xl mx-auto">
        ...
        <div className="animate-fade-in-up bg-primary-100 rounded-3xl shadow-2xl overflow-hidden">
          {/* Quote bar */}
          <div className="bg-gradient-to-r from-navy-800 to-navy-900 px-8 py-4 flex items-center gap-3">
            <span className="text-primary-100/60 text-5xl leading-none font-serif">"</span>
            <p className="text-primary-100/90 text-sm font-medium uppercase tracking-widest">Message from Nidhi Sharma, FCA</p>
          </div>

          <div className="px-8 md:px-14 py-10 space-y-6 text-navy-900 text-lg leading-relaxed">
            <p>
          ...
          {/* Signature block */}
          <div className="px-8 md:px-14 pb-10 flex items-center gap-5 border-t border-primary-200 pt-6">
            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-navy-800 to-navy-900 flex items-center justify-center text-white text-xl font-bold flex-shrink-0">
              NS
            </div>
            <div>
              <p className="font-bold text-navy-900 text-lg">Nidhi Sharma</p>
