export default function Mission() {
  return (
    <section className="section-padding relative overflow-hidden">
      ...
      <div className="absolute top-0 right-[20%] w-96 h-96 bg-primary-400/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-[10%] w-80 h-80 bg-primary-500/5 rounded-full blur-3xl"></div>
