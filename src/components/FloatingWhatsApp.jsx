export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-22 right-6 z-40 flex items-center justify-center transition-transform duration-300 hover:scale-110 group"
      title="Contact us on WhatsApp"
    >
      <img
        src="/whatsapp-logo.png"
        alt="WhatsApp"
        className="w-12 h-12 md:w-14 md:h-14 object-contain rounded-2xl"
      />
