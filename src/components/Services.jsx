        ...
        <div className="mt-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
            {ngrbcPrinciples.map((p) => (
              <div key={p.number} className="flex items-start gap-4 bg-gradient-to-br from-sky-50/80 to-blue-200/70 border border-primary-200/60 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow duration-300">
