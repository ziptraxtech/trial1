export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-25 right-6 z-40 w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110 group"
